...
# 8. 테스트 계획 및 결과 보고서 
<테스트 계획서>
   ![Image](https://github.com/user-attachments/assets/339c3efb-3b6e-4c85-a45e-75cb6d4fb20b)
<결과 보고서>
 ![Image](https://github.com/user-attachments/assets/45c76c80-2b44-4c38-b44b-77299f7540cf)
# 9. 수행결과(테스트/시연 페이지)
![Image](https://github.com/user-attachments/assets/c433d209-182b-4db7-ac70-6d309aeb5441)
<br>
![Image](https://github.com/user-attachments/assets/418289ce-4ff0-4d44-b8d0-860e613a4cb4)
<br>
![Image](https://github.com/user-attachments/assets/a734cef5-c5db-4d5e-8dbd-88db90f2c630)
<br>
![Image](https://github.com/user-attachments/assets/6bfdea8a-9e99-41a8-9c61-36cc5fbc124d)
<br>

# 10. 한 줄 회고
💰 서예찬: 모델의 성능을 높이는데 집중을하다 시간분배를 잘못해 전체적인 퍼포먼스부분에서 기준점을 만족하지못한것같아 많은점에서 아쉽게느껴졌던 프로젝트였던것같습니다. <br>
💰 전성원: 많은 변수들이 있어서 다사다난했던 프로젝트였던 것 같습니다, 솔직히 파인튜닝을 진행하면서 더 성능 좋은 모델을 뽑아보고싶었는데 장비나 비용 등의 외적인 원인으로 선택과 타협으로 퍼포먼스적인 부분을 챙길 수 없었던 점이 안타까웠습니다. <br>
💰 조민훈: 클라이언트의 니즈와 실사용자의 니즈를 구체적으로 파악해야하는 것이 매우 중요하다. <br>
💰 최재동: 이번에 한 프로젝트는 django, aws ec2, langchain등 다양한 기능을 한데 엮는 프로젝트라 여러가지 어려움이 많았습니다. 각각의 요소들을 연결하면서 초기 설계를 정확히 하는 것의 중요성을 느꼈습니다.<br>
